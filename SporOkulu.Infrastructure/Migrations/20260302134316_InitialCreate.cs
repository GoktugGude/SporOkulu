    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentTestResults_TestTypes_TestTypeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "6d92c18b-ad50-4cbb-a935-81672274f3df", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "44deaa09-7de8-451a-96bb-d40febe35e2e", "goktuggude@gmail.com", true, "Goktug", "GUDE", false, null, "GOKTUGGUDE@GMAIL.COM", "GOKTUGGUDE@GMAIL.COM", "AQAAAAIAAYagAAAAENPpC4oRsctgszQ7e4MgIv+CyemwE3J0cCh7QNTACB0w14UJLPJ6aJde5jF7BKSKIw==", null, false, "9ca07185-1815-4674-9f44-67f707f15e75", false, "goktuggude@gmail.com" });

            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Id", "MonthlyFee", "Name" },
                values: new object[,]
                {
                    { 1, null, "Basketbol" },
                    { 2, null, "Futbol" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTestResults_TestTypeId",
                table: "StudentTestResults",
                column: "TestTypeId");
        }
